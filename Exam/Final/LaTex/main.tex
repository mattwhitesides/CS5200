...
... See "5a\_Output.txt" in Zip file for full output.
        ...
        So finally we can see that the \textbf{MST of the sub-trees is 7540}. See "5\textbackslash5a\_Output.txt" for the edge list and the total weights and edges of the rest of the graph.
