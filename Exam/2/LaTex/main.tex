...
\begin{document}
  ...
  f(5) =  24576 , f2(5) =  24576
    ...
    \begin{enumerate}
      ...
      Now lets assume the our theory is incorrect that a graph can have two or more disconnected subgraphs. Each subgraph node would still have to have $deg(v) \geq n/2$, thus each subgraph would need at least $\frac{n}{2} + 1$ nodes in it.
      That would make our total nodes of all subgraphs equal $(\frac{n}{2} + 1) + (\frac{n}{2} + 1) ...$ which would give us a total of $n + 2$ or more nodes which is impossible. 
      ...
      An example of a graph where $deg(v) = n/2 -1$ for all v but is disconnected, would be our cas $P(2)$ each node would have a degree of $\frac{2}{2} - 1 = 0$ which is obvisouly just two stand alone disconnected nodes.
    \end{enumerate}
